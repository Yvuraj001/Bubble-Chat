      ...
      <div className="relative z-10 flex items-center gap-3 px-1 md:px-6 py-2 border-b border-white/10 bg-white/5 backdrop-blur-sm">
        ...
        <div>
          ...
          <p className="text-[10px] md:text-xs text-emerald-300/60 tracking-widest ">
            Inside - <strong className="uppercase">{roomName || "..."}</strong>
          </p>
        </div>
        <div className="ml-auto flex  items-center justify-center text-[10px] md:text-[14px] gap-2 opacity-60 text-white">
        ...
        {showMessagesToNewUser.length > 0 && (
          ...
          >
            ...
            <div className="w-[78vw] flex items-center my-6 mx-auto">
              <div className="flex-1 h-px bg-linear-to-l from-transparent to-white/20 rounded-full"></div>
